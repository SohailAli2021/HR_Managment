...
class TrainingController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'status' => 'required|in:active,inactive,inprogress,completed',
...
public function downloadTrainingsPDF()
{
    $trainings = Training::with(['trainingType', 'trainer', 'employees'])->get();
    $pdf = PDF::loadView('HR.Trainings.trainings_pdf', compact('trainings'));

    return $pdf->download('trainings_report.pdf');
}
