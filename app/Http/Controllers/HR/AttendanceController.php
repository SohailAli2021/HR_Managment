...
//     return view('HR.Attendance.attendance_show', compact('attendance'));
// }
public function showAttendance()
{
...
{
    $attendance = Attendance::where('date', now()->toDateString())->get();
    $pdf = PDF::loadView('HR.Attendance.todayattendance_pdf', compact('attendance'));

    return $pdf->download('todayattendance_report.pdf');
}
