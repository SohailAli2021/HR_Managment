                                ...
                                <ul>
                                    @foreach ($leaveRequests as $leave)
                                        <li>
                                            ...
                                            Dates: {{ $leave->start_date }} to {{ $leave->end_date }}<br>
                                            Reason: {{ $leave->reason }}<br>
                                            {{-- <span class="badge bg-inverse-danger" style="font-size: 14px">{{ $leave->status }} </span> --}}
                                            Status: <span class="badge bg-inverse-success" style="font-size: 14px">{{ $leave->status }} </span>
                                        </li>
                                    @endforeach
                                </ul>
                            @endif
