                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select name="month" class="form-control" required>
                                            <option value="1"{{ $addition->month == 1 ? ' selected' : '' }}>January</option>
                                            <option value="2"{{ $addition->month == 2 ? ' selected' : '' }}>February</option>
                                            <option value="3"{{ $addition->month == 3 ? ' selected' : '' }}>March</option>
                                            <option value="4"{{ $addition->month == 4 ? ' selected' : '' }}>April</option>
                                            <option value="5"{{ $addition->month == 5 ? ' selected' : '' }}>May</option>
                                            <option value="6"{{ $addition->month == 6 ? ' selected' : '' }}>June</option>
                                            <option value="7"{{ $addition->month == 7 ? ' selected' : '' }}>July</option>
                                            <option value="8"{{ $addition->month == 8 ? ' selected' : '' }}>August</option>
                                            <option value="9"{{ $addition->month == 9 ? ' selected' : '' }}>September</option>
                                            <option value="10"{{ $addition->month == 10 ? ' selected' : '' }}>October</option>
                                            <option value="11"{{ $addition->month == 11 ? ' selected' : '' }}>November</option>
                                            <option value="12"{{ $addition->month == 12 ? ' selected' : '' }}>December</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row" >
