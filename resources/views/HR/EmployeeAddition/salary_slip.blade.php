                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 m-b-20">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>Joining Date: {{ $employee->start_date }}</li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><strong>Present Days</strong> <span class="float-right">{{ $attendance }}</span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Basic Salary After Deductions</strong> <span class="float-right">{{number_format(round(($basic_salary_after_deductions), 2))}}</span></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td><strong>Total Earnings</strong> <span class="float-right"><strong>{{number_format(round(($totalSalary), 2))}}</strong></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td><strong>Tax Deducted at Source (T.D.S.)</strong> <span class="float-right">({{ $deductions->tax_percent }}%): {{number_format(round(($tax), 2))}}</span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Provident Fund</strong> <span class="float-right">({{ $deductions->fund_percent }}%): {{number_format(round(($fund), 2))}}</span></td>
                                                </tr>
                                                
                                                <tr>
                                                    <td><strong>Total Deductions</strong> <span class="float-right"><strong>{{number_format(round(($totalDeductions), 2))}}</strong></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <h4><strong>Net Salary:  Rs. {{number_format(round(($netSalary), 2))}} </h4><p>only ({{ \App\Helpers\NumberToWords::convertToWords($netSalary) }})</p></strong>
                                </div>
                            </div>
                        </div>
                    </div>
