				...
				<th>Select Status</th>
							...
							<tbody>
								...
								<tr>
									...
									<td><span class="badge bg-inverse-danger" style="font-size: 14px">{{ ucfirst($application->job->job_type) }}</span></td>
									{{-- <td>{{ ucfirst($application->job->job_type) }}</td> --}}
									<td><a href="{{ route('job_applications.cv', ['jobApplication' => $application]) }}" target="_blank">Download CV</a>
									</td>
									<td><span class="badge bg-inverse-success" style="font-size: 14px">{{ ucfirst($application->status) }}</span></td>
