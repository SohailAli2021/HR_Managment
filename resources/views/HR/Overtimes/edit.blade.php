                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select name="month" class="form-control" required>
                                            <option value="1"{{ $overtime->month == 1 ? ' selected' : '' }}>January</option>
                                            <option value="2"{{ $overtime->month == 2 ? ' selected' : '' }}>February</option>
                                            <option value="3"{{ $overtime->month == 3 ? ' selected' : '' }}>March</option>
                                            <option value="4"{{ $overtime->month == 4 ? ' selected' : '' }}>April</option>
                                            <option value="5"{{ $overtime->month == 5 ? ' selected' : '' }}>May</option>
                                            <option value="6"{{ $overtime->month == 6 ? ' selected' : '' }}>June</option>
                                            <option value="7"{{ $overtime->month == 7 ? ' selected' : '' }}>July</option>
                                            <option value="8"{{ $overtime->month == 8 ? ' selected' : '' }}>August</option>
                                            <option value="9"{{ $overtime->month == 9 ? ' selected' : '' }}>September</option>
                                            <option value="10"{{ $overtime->month == 10 ? ' selected' : '' }}>October</option>
                                            <option value="11"{{ $overtime->month == 11 ? ' selected' : '' }}>November</option>
                                            <option value="12"{{ $overtime->month == 12 ? ' selected' : '' }}>December</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
