	 ...
	 <br>
		...
		<div class="row">
				...
				<th class="text-right">Actions</th>
						...
						<td><span class="badge bg-inverse-success" style="font-size: 14px">{{ $row->role }}</span></td>
						<td>{{ $row->emp_status->status }}</td>
						<td><span class="badge bg-inverse-danger" style="font-size: 14px">{{ $row->job_status }}</span></td>
