            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto float-right ml-auto">
						<a href="{{ route('trainings.create') }}" class="btn add-btn"  data-target="#add_leave"><i class="fa fa-plus"></i> Add Training</a>
					</div>
                    <div class="col-auto float-right ml-auto">
                        <a href="{{ route('trainings.download-pdf') }}" target="_blank" class="btn btn-primary" > Download PDF</a>
                    </div>
                </div>
            </div>
            ...
            <th class="text-right">Actions</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $training->num_of_employees }}</td>
                                <td><span class="badge bg-inverse-success" style="font-size: 14px">{{ $training->status }}</span></td>
                        {{-- <td>{{ $training->status }}</td> --}}
                                <td class="text-right">
