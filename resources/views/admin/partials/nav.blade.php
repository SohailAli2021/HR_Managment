    ...
    <ul class="nav user-menu">
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                ...
                @endphp
                <span class="user-img"><img src="{{ asset('images/' . $avatar) }}" alt="">
            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li><a class="active" href="{{url('adminindex')}}">Admin Dashboard</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <li><a href="{{url('attendance/showall')}}">Today's Attendance (Employee)</a></li>
