...
Route::get('attendance/showall', 'HR\AttendanceController@showAttendance')
    ->name('attendance.showall');
Route::get('attendance/download-pdf', 'HR\AttendanceController@downloadAttendancePDF')->name('attendance.download-pdf');
...
Route::get('trainings/download-pdf', 'HR\TrainingController@downloadTrainingsPDF')->name('trainings.download-pdf');
